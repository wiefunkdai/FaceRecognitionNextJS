...
If you find any problems in the coding provided by **StephanusDai**. You can submit a new [**`Trouble Tickets`**](https://github.com/wiefunkdai/FaceRecognitionNextJS/discussion) reposity.

## :bulb: Forum Discussions

Communicate well to find what you are looking for through this [**`Discussions`**](https://github.com/wiefunkdai/FaceRecognitionNextJS/discussion) reposity.

> :warning: **WARNING!**\
> *The [Issue Forms](https://github.com/wiefunkdai/FaceRecognitionNextJS/issues/) and [Discussion Forums](https://github.com/wiefunkdai/FaceRecognitionNextJS/discussions/) in each repository are different from Global Discussions and Global Issues,
...
You first need to create a fork of the [FaceRecognitionNextJS](https://github.com/wiefunkdai/FaceRecognitionNextJS) repository to commit your changes to it.
...
```sh
# Using HTTPS
git remote add fork https://github.com/YOUR-USERNAME/FaceRecognitionNextJS.git
git remote add upstream https://github.com/wiefunkdai/FaceRecognitionNextJS.git


# Using SSH
git remote add fork git@github.com:YOUR-USERNAME/FaceRecognitionNextJS.git
git remote add upstream git@github.com/wiefunkdai/FaceRecognitionNextJS.git
```
...
Commit your changes, then push the branch to your fork with `git push -u fork` and open a pull request on the [FaceRecognitionNextJS](https://github.com/wiefunkdai/FaceRecognitionNextJS/) repository following the template provided.
